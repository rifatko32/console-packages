...
public class PlacePackagesFromTxtFileToConsoleCommand implements Command {
    ...
    public void execute() {
        ...
        var reportWriter = reportWriterFactory.createReportWriter(ReportOutputChannelType.CONSOLE, null);
